                        ...
                        <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700/50">
                            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4"><div><label className="text-xs text-gray-500 block mb-1">Safe Offer Amount (ARV x 40%)</label><div className="relative"><span className="absolute left-2 top-2 text-gray-400">$</span><input disabled type="text" className="w-full bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded p-2 pl-6 text-gray-700 dark:text-gray-300 text-sm" value={formatNumberWithCommas(safeOfferAmount)} /></div></div><div><label className="text-xs text-gray-500 block mb-1">SureCash Offer (List - $70k)</label><div className="relative"><span className="absolute left-2 top-2 text-gray-400">$</span><input disabled type="text" className="w-full bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded p-2 pl-6 text-gray-700 dark:text-gray-300 text-sm" value={formatNumberWithCommas(sureCashOfferAmount > 0 ? sureCashOfferAmount : 0)} /></div></div></div>
                                </div>
                            </div>
